    ...
    <div>
        <div class="mt-2" style="display: inline-flex;">
            <asp:DropDownList ID="uiEventos" runat="server" CssClass="form-control mr-3" onchange="MuestraEventos();" ClientIDMode="Static">
                ...
                <asp:ListItem Value="1">Registrados</asp:ListItem>
            </asp:DropDownList>
             <asp:DropDownList ID="uiFinalizados" runat="server" CssClass="form-control mr-3" onchange="MuestraEventos();" ClientIDMode="Static">
                <asp:ListItem Value="2" Selected="True">Todos ...</asp:ListItem>
                <asp:ListItem Value="0">Proximos</asp:ListItem>
        ...
        <div class="content">
            <div class="row">
                ...
                <div id="divCards" runat="server" style="display: contents; width: 100%;"></div>
            ...
            <div id="ModalLoad" runat="server" class="modal" tabindex="-1" role="dialog" aria-labelledby="ModalLoad" aria-hidden="true" style="display:block;background-color: #0000008f;" clientidmode='Static'>
                <div class="modal-dialog" role="document"  style="position: relative;top: 50%;transform: translateY(-50%);">
